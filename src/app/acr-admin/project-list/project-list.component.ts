...
export class ProjectListComponent implements OnInit {
  ...
  viewDetails(projectId: string): void {
    ...
    this.closeDropdown();
    this.router.navigate(['/acr-admin/projects', projectId]);
  }

  viewJobs(projectId: string): void {
    // Navigate to job list page for the specific project
    this.closeDropdown();
    this.router.navigate(['/acr-admin/jobs'], { queryParams: { projectId: projectId } });
  }

  openAddJobModal(): void {
    // Navigate to job add page instead of project add page
    this.router.navigate(['/acr-admin/project/add']);
  }

  openEditProjectModal(project: any): void {
    // Navigate to edit page instead of opening modal
    this.closeDropdown();
    this.router.navigate(['/acr-admin/project/edit', project._id]);
  }
